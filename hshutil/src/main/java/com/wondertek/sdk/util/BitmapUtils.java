        ...
        if(bitmap != null && !bitmap.isRecycled()) {
            try {
                ...
                if(byteArrayOutputStream.toByteArray() == null) {
                    LogUtils.e("bitmap2Bytes byteArrayOutputStream toByteArray=null");
                }
                return byteArrayOutputStream.toByteArray();
            } catch (Exception e) {
                LogUtils.e("bitmap2Bytes exception", e);
            } finally {
            ...
            LogUtils.e("bitmap2Bytes bitmap == null or bitmap.isRecycled()");
            return null;
        }
    }
        ...
        if(datas != null && datas.length > byteCount) {
            ...
            if(outputStream != null) {
                ...
                if(outputStreamByte.length > byteCount) {
                    LogUtils.e( "compressBitmap cannot compress to " + byteCount + ", after compress size=" + outputStreamByte.length);
                }
